# translate - AI Assistant Instructions

**Package**: `@apps/translate`
**Version**: 0.1.0
**Type**: apps package

## Package Overview

**Description**: Translation Tool - Multi-language translation utility

**Purpose**: Provide translation tool - multi-language translation utility functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/translate` - Main executable
...
1. **Test installation**: `stow translate`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D translate`
